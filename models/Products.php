        ...
        class Products
        {
            ...
            {
                sendResponse((new ProductModel('protects'))->find($_GET['SKU']));
            }
            
            public static function get_all_product_types(): void
            {
                sendResponse(200, json_encode((new ProductTypeModel('product_types'))->show_all()));
            }
            ...
            public static function get_all_type_properties(): void
            {
                try {
                    ...
                    sendResponse(500, ["Status" => "Failed", "Error" => $e]);
                }
            }
            ...
            public static function get_all_product_properties(): void
            {
                try {
                    ...
                    sendResponse(500, json_encode(["Status" => "Failed", "Error" => $e]));
                }
            }
